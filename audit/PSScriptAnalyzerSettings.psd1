@{
    ...
    Rules = @{
        ...
        PSAvoidUsingBrokenHashAlgorithms = @{ Enable = $true } # Warning: Flags MD5/SHA1 in security contexts
        PSAvoidUsingDeprecatedManifestFields = @{ Enable = $true } # Warning: Catches outdated module manifests
        ...
        PSAvoidGlobalVars = @{ Enable = $true } # Warning: Prevents global state pollution
        PSAvoidDefaultValueForMandatoryParameter = @{ Enable = $true } # Warning: Catches conflicting declarations
        PSAvoidShouldContinueWithoutForce = @{ Enable = $true } # Warning: Ensures proper -Force implementation
